...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/cause-edit/{]', [\App\Http\Controllers\Back\CauseController::class, 'edit'])->name('cause-edit');
    Route::put('/cause-update', [\App\Http\Controllers\Back\CauseController::class, 'update'])->name('cause-update');
