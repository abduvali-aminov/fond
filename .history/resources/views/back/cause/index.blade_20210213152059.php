                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a href="{{ route('cause-edit', $cause->id) }}" class="btn btn-success"><span class="glyphicon glyphicon-edit">Edit</span> </a>
                            ...
                            @csrf
                            @method('delete')
                            <input type="submit" value="Delete" class="btn btn-danger glyphicon glyphicon-trash "
                            onclick="return confirm('Are you sure?')">
                                {{-- <span  onclick="return confirm('Are you sure?')" class="" aria-hidden="true">Delete</span> --}}
                            </form>
                        </a>
                    </td>
                </tr>
