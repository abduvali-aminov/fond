...
@section('content')
    <div class="container ">
                ...
                @foreach ($applies as $counter => $apply)
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="{{ route('apply-show', $apply->id) }}" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span> Edit</a>
        ...
        <a href="{{ route('history-all') }}" class="btn btn-block btn-success">History</a>
