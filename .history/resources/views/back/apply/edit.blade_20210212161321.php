...
@section('content')
    ...
    <div class="container">
        ...
        <form method = "POST" action = "{{ route('apply-update', $apply->id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5 input-group-lg">
                ...
                <div class="form-row " >
                    ...
                    <div class="form-group input-group-lg col-md-2">
                        ...
                        <select name="summa_id"  class="form-control">
                ...
                <div class="form-row">
                    <div class="form-group input-group-lg col-md-8">
                        ...
                        <textarea type="text" class="form-control"  name="description" rows="3">{{ $apply->description }}</textarea>
                    </div>
