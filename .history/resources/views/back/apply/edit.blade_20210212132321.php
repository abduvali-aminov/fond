            ...
            <div>
                ...
                <div class="form-row " >
                    ...
                    <div class="form-group input-group-lg col-md-2">
                        ...
                        <input type="textarea" name="required_amount" class="form-control" id="summ" value="{{ $apply->required_amount }}">
                ...
                <div class="form-row">
                    <div class="form-group input-group-lg col-md-8">
                        ...
                        <input type="textarea" class="form-control" id="description" name="description" rows="3" value="{{ $apply->description }}"></input>
                    </div>
