...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-1 ">
                <option id="rating" class="rating" data-url="{{ route('edit_status', $apply->id) }}" data-pk="{{ $rating->id }}" data-type="select" data-placement="right" data-title="Edit Rate" value="{{$status->id}}">{{$status->title}}</option>
