...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-1 ">
                <input data-id="{{$apply->id}}" class="toggle-class" type="checkbox" data-onstyle="primary" data-offstyle="dark" data-toggle="toggle" data-on="See" data-off="Sawed" {{ $apply->status ? 'checked' : '' }}>
            </div>
        </div>
    </div>
@endsection
