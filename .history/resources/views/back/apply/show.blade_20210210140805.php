...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-1 ">
                <option id="apply" class="rating" data-url="{{ route('edit_status', $apply->id) }}" data-pk="{{ $apply->id }}" data-type="select" data-placement="right" data-title="Edit Rate" value="{{$apply->id}}">{{$status->title}}</option>
