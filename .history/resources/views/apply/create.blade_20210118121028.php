...
@section('content')
    ...
    <div class="container mt-2 mb-2">
        ...
        <form method = "POST" action="{{ route('apply-store') }}" enctype="multipart/form-data" class="mt-2">
            ...
            <div class="form-group">
                <input type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control" name="required_amount" placeholder="Requarment Amount">
            </div>
            ...
            <div class="form-group">
                <input class="form-control" oninput="this.value = this.value.replace(/[^0-9.+]/g, '').replace(/(\..*?)\..*/g, '$1');" name="phone" placeholder="Enter phone number">
            </div>
