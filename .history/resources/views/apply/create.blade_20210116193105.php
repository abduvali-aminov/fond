...
@section('content')
    ...
    <div class="container mt-2 mb-2">
        ...
        <form method = "POST" action="{{ route('apply-store') }}" enctype="multipart/form-data" class="mt-2">
            ...
            <div class="form-group">
                <select name="summa_id" id = "summ_id" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="text" name="photo_1" class="form-control" >
            </div>

            <div class="form-group">
                <label>Choose photo:</label>
                <input type="text" name="photo_2" class="form-control" >
            </div>

            <div class="form-group">
                <label>Choose photo:</label>
                <input type="text" name="photo_3" class="form-control-file" >
            </div>
