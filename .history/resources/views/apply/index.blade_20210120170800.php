                ...
                <div class="col mt-2">
                    <div class="wrapper">
                        <div class="card h-100">
                            {{-- <div class="col"> --}}
                                <a  data-toggle="lightbox" data-gallery="mixedgallery" class="col-sm-4">
                                    <img src="http://i1.ytimg.com/vi/yP11r5n5RNg/mqdefault.jpg" >
                                    <img class="p-1" src="{{ Storage::url($apply->photo_1) }}"  class="img-fluid" />
                                </a>
                                <div class="card-body">
                                    <div class="exam">
