                                        ...
                                        <div class="pay__card">
                                            <div class="pay__type-card">
                                                ...
                                                <label for="payme" style="width: 95px;">
                                                    <img width="100%" src="{{ asset('/img/click-logo-PNG-1920x700.png') }}"  src="./public/images/payme_01.svg" alt="payme">
                                                </label>
                                            </div>
                                            <div class="pay__type-card">
                                                <input type="radio" name="input" id="click">
                                                <label for="click" style="width: 95px;">
                                                    <img width="100%" src="{{ asset('/img/click-logo-PNG-1920x700.png') }}"  alt="click">
                                                </label>
                                            </div>
                                            <div class="pay__type-card">
                                                <input type="radio" name="input" id="visa">
                                                <label for="visa" style="width: 95px;">
                                                    <img width="100%" src="{{ asset('/img/Visa.svg') }}" alt="visa">
                                                </label>
                                            </div>
                                            <div class="pay__type-card">
                                                <input type="radio" name="input" id="sberbank">
                                                <label for="sberbank" style="width: 95px;">
                                                    <img width="100%" src="{{ asset('/img/sberbank-3.svg') }}" alt="sberbank">
                                                </label>
                                            </div>
                                        </div>
                                    </div>
