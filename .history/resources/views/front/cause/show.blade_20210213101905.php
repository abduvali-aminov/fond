...
@section('content')
    <section class="header header_fond">
        <div class="container">
            <nav class="nav">
                    <div class="nav-logo">
                        <a href="#">
                            <img src="./public/images/xursandwhite.png" alt="Logo fond">
                        </a>
                    </div>
                    <ul class="nav-menu">
            ...
            <div class="donation-wrap">
                <div class="donation__desc">
                    ...
                    <div class="donation__auth">
                        <img src="./public/images/gifts.svg" alt="auth">
                    </div>
            ...
            <div class="card-content">
                <div class="container">
                    ...
                    <div class="card-desc">
                        ...
                        <div class="card-desc__link small">
                            <div class="img"
                                style="background: url(https://blog.pixlr.com/wp-content/uploads/2019/03/stars-pattern.png) no-repeat center center / cover; height: 100%; width:100%">
                            </div>
                            <div class="desc">
                                <div class="desc__content">
                                    <div class="desc__title">Lorem, ipsum dolor.</div>
                                    <div class="desc__text">
                                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus
                                            assumenda
                                            voluptates numquam at dicta quis porro aliquam nihil unde. Exercitationem!</p>
                                            <div class="desc__price">
                                                <div class="desc__collected">
                                                    <h4>собрано</h4>
                                                    <span>255 000</span>
