            ...
            <div class="author-card__head">
                <div class="author-card__title">
                    <div class="author-card__img">
                        <img src="{{ Storage::url($apply->photo_1) }}" alt="author" width="200px">
                    </div>
                    <div class="author-card__desc">
                        <h1 class="author-card__name">{{ $apply->name }}</h1>
                        <div class="author-card__age">{{ $apply->updated_at }}</div>
                        <div class="author-card__cause">{{ $apply->causes->name }}</div>
                        <div class="author-card__address">{{ $apply->address }}</div>
                        <div class="author-card__address">{{ $apply->required_amount }} {{ $apply->summ_type->name }}</div>
                        <div class="author-card__address">{{ $apply-> }} {{ $apply->summ_type->name }}</div>
                    </div>
                </div>
