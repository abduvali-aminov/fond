                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" name="phone_number" placeholder="(YYYY) XXXXXXXX" id="phone_number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"/>
                                </div>
                                        ...
                                        <div class="form-select">
                                            ...
                                            <div class="select-list">
                                                <select name="meal_preferencec" id="meal_preferencec">
                                                    <option value="Vegetarian">Sum</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    ...
                                    <textarea name="desc" id="desc" placeholder style="width: 100%; max-height: 300px; height: 200px; resize: none;"></textarea>
                                </div>
                            </div>
                        </div>
