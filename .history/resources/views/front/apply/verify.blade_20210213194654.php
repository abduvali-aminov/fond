        ...
        <div class="modal-wrap">
            <div class="modal-wrap__card">
                ...
                <form method="POST" action="{{ route('verify') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="code" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="Введите код">
...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi reprehenderit aut sit architecto iste eveniet nisi praesentium ullam assumenda blanditiis?
