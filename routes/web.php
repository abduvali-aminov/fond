...
Route::get('/front-apply-create', [AppliesController::class, 'create'])->name('front-apply-create');
Route::post('/front-apply-store', [AppliesController::class, 'store'])->name('front-apply-store');
...
Route::get('/front-cause-show/{id}', [\App\Http\Controllers\MainController::class, 'show'])->name('front-cause-show');
Route::get('/front-show-item/{id}',[\App\Http\Controllers\AppliesController::class, 'show'])->name('front-show-item');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/apply-edit/{id}', [\App\Http\Controllers\Back\AppliesController::class, 'edit'])->name('apply-edit');
    Route::put('/apply-update/{id}', [\App\Http\Controllers\Back\AppliesController::class, 'update'])->name('apply-update');
    ...
    Route::delete('/cause-delete/{id}', [\App\Http\Controllers\Back\CauseController::class, 'destroy'])->name('cause-delete');
...
return view('front.apply.create');
});
